from Plugins.sequence_formatter import format_name
import re
import asyncio
import logging 
...
def extract_file_info(filename, file_format, file_id=None):
    ...
    formatted = format_name(user_id, episode)
...
async def mode_cmd(client: Client, message: Message):
    try:
        ...
        await handle_floodwait(message.reply_text, f" ᴇʀʀᴏʀ ᴏᴄᴄᴜʀʀᴇᴅ. Pʟᴇᴀsᴇ ᴛʀʏ ᴀɢᴀɪɴ {e}.")
...
async def rem_dump_cmd(client: Client, message: Message):
    try:
        ...
        await handle_floodwait(message.reply_text, " ᴇʀʀᴏʀ ᴏᴄᴄᴜʀʀᴇᴅ. Pʟᴇᴀsᴇ ᴛʀʏ ᴀɢᴀɪɴ.")
...
async def leaderboard_cmd(client: Client, message: Message):
    ...
    try:
        ...
        if current_user_rank is None:
            ...
            leaderboard_text += "୨⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯୧\n"
            leaderboard_text += f"シ <b>You ranked #{current_user_rank}!</b>"
