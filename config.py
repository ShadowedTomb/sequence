...
TG_BOT_TOKEN = os.environ.get("BOT_TOKEN", "8537306630:AAF5DNCLxchTuFiGXyer46yCz8PTRRhimX0")
...
DB_URL = os.environ.get("DB_URI", "mongodb+srv://JeffyBackUp:JeffyBackUp@cluster0.hgbjdhr.mongodb.net/?retryWrites=true&w=majority")
